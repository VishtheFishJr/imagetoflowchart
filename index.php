...
give me full file back with these changes: 1. buttons for login and sign up if not logged in. 2. logout button when
logged in, should take you to login.php. 3. if not logged in and go to site, you can use the buttons, but you can't go
to view your files. when you click my files button, it takes you to login.php. 4. if a new user logs in, it should not
have a google account connected. underneath the part where it says error google account not connected, add a link that
takes you to vishthefishjr.me/google_login.php. make all these changes, change nothing else, and give me the full file
back, it can be a downloadable file

Your PHP file is ready

PHP icon
index
PHP
Open
Here is the updated full file (index.php) with all requested changes applied:

HTML
<?php
session_start();
$is_logged_in = isset($_SESSION['user_id']) || isset($_SESSION['user']) || isset($_SESSION['username']) || (!empty($_SESSION['logged_in']) && $_SESSION['logged_in'] !== false);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    ===================================================== -->
        ...
        <div class="topbar">
            ...
            <?php else: ?>
                <button class="storage-toggle" onclick="window.location.href='login.php'">
